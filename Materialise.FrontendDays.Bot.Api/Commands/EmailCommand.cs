...
namespace Materialise.FrontendDays.Bot.Api.Commands
{
    public class EmailCommand : ICommand
    {
        ...
        private readonly ILogger<EmailCommand> _logger;

        public EmailCommand(TelegramBotClient botClient, IDbRepository<User> usersRepository,
            PlayGameCommand playGameCommand, ILogger<EmailCommand> logger)
        {
